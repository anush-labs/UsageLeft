...
UsageLeft is a GUI app. A one-off `export ...` in a terminal session will not be visible when you launch UsageLeft from
Spotlight/Launchpad. Persist it, then restart UsageLeft.
...
3. Enable the Z.ai plugin in UsageLeft settings
